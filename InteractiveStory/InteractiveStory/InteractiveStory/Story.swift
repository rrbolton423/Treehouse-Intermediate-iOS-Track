...
//  InteractiveStory
//
//  Created by ROMELL  BOLTON on 7/27/18.
...
extension Story {
    var artwork: UIImage {
        ...
        case .homeward: return #imageLiteral(resourceName: "TouchDown")
    ...
    var text: String {
        ...
        case .returnTrip(let name):
            return "On your return trip from studying Saturn's rings, you hear a distress signal that seems to be coming from the surface of Mars. It's strange because there hasn't been a colony there in years. \"Help \(name), you're my only hope.\""
        case .touchDown:
